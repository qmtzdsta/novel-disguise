...
可自定义浏览器标签页显示的标题名称，分别对应Word与Excel模式。
留空则使用默认值：Word为“文档1”，Excel为“工作簿1”。

### 文档标题（页面内）

可自定义页面内顶部标题栏的文档标题，分别对应Word与Excel模式。
开启“自定义文档标题”后，若输入为空则继续使用章节标题。
